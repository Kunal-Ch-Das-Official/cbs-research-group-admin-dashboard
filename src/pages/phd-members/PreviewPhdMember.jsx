              ...
              <div className="flex rounded-t-lg bg-gray-200 sm:px-2 w-full">
                <div className="h-40 w-40 overflow-hidden sm:rounded-full sm:relative sm:p-0 top-10 left-5 p-3">
                  <img
                    ...
                    alt={memberInfo.profilePicturePublicId}
                  />
                </div>
                ...
                <div className="w-11/12 sm:text-center pl-5 mt-10 text-start">
                  ...
                  <p className="text-heading mt-1">PHD Member</p>
                  <p className="text-center inline-flex item-center">
                    <a
                      href={`https://${memberInfo.googleScholarId}`}
                      target="_blank"
                    ...
                    <a
                      href={`https://${memberInfo.researchGateId}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                ...
                <div className="flex flex-col sm:flex-row sm:mt-10">
                    ...
                    <div className="py-3 sm:order-none order-3">
                      ...
                      <div className="flex flex-col justify-start ml-0 mr-2 text-lg font-bold text-gray-500">
                        ...
                        <div className="flex flex-col items-start my-1">
                          <div className="ml-0 lg:ml-6">
                            {"BSC: "}
                            {memberInfo.bscDoneFrom}
                          </div>
                        </div>
                        <div className="flex flex-col items-start my-1">
                          <div className="ml-0 lg:ml-6">
                            {"MSC: "}
                            {memberInfo.mscDoneFrom}
                          </div>
                        </div>
                        <div className="flex items-start my-1">
                          <div className="ml-0 lg:ml-6">
                            {" "}
                            {memberInfo.currentYear}
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:w-2/3 sm:-mt-10">
                    <div className="py-3">
                      ...
                      <p className="text-start">{memberInfo.details}</p>
