...
const DeletePersonalAward = () => {
  ...
  const handlePersonalAwardDelete = async () => {
    ...
    try {
      setLoading(true);
      await axios
        .delete(`${envConfig.personalAwardsUrl}/${id}`, {
          headers: {
        ...
        >
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-row justify-between mx-2">
              <button
                onClick={handlePersonalAwardDelete}
           ...
           hover:bg-red-600`}
              ...
              <button
                onClick={() => navigate("/admin-panel/manage-personal-awards")}
