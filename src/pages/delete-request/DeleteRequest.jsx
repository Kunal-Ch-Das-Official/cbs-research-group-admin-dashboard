  ...
  const deleteMessageHandler = async () => {
    ...
    try {
      ...
      await axios
        ...
        .then((res) => {
          const approvedMessage = localStorage.getItem(`isAccepted-${id}`);
          const rejectedMessage = localStorage.getItem(`isRejected-${id}`);
          approvedMessage && localStorage.removeItem(`isAccepted-${id}`);
          rejectedMessage && localStorage.removeItem(`isRejected-${id}`);
          setAlertMessage({
