          ...
          <div>
            <div className="-mt-px flex divide-x  divide-gray-200">
              <div className="flex w-0 flex-1">
                <Link
                  to={`/admin-panel/preview-phd-member/${id}`}
              ...
              <div className="-ml-px flex w-0 flex-1">
                <Link
                  to={`/admin-panel/update-phd-member/${id}`}
              ...
              <div className="-ml-px flex w-0 flex-1">
                <Link
                  to={`/admin-panel/delete-phd-member/${id}`}
